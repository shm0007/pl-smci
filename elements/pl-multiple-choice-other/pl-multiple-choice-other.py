...
def prepare(element_html, data):
    ...
    if len_correct < 1 and not enable_nota:
        ...
        raise Exception('pl-multiple-choice-other element must have at least 1 correct answer or set none-of-the-above')

    if enable_aota and len_correct < 2:
        # To prevent confusion on the client side
        raise Exception('pl-multiple-choice-other element must have at least 2 correct answers when all-of-the-above is set')
...
def render(element_html, data):
    ...
    if data['panel'] == 'question':
        ...
        with open('pl-multiple-choice-other.mustache', 'r', encoding='utf-8') as f:
